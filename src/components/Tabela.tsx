...
export default function Tabela(props: any) {
    ...
    function renderizarDados(){
        return props.clientes?.map((cliente: { id: boolean | Key | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | null | undefined; nome: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; idade: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; }, i: number) => {
            return (
                <tr key={cliente.id}
